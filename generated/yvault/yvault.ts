...
export class yvault__strategiesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class yvault extends ethereum.SmartContract {
  static bind(address: Address): yvault {
    return new yvault("yvault", address);
  }
  ...
  strategies(arg0: Address): yvault__strategiesResult {
    let result = super.call(
      "strategies",
    ...
    return new yvault__strategiesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_strategies(arg0: Address): ethereum.CallResult<yvault__strategiesResult> {
    let result = super.tryCall(
      "strategies",
      "strategies(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0)]
